...
static CliParser parsers[] = {
    ...
    {str_lit("-cfg-png"),   0, CLI_CFG_CREATE_PNG, "-cfg-png", "Create graphviz control flow graph as a PNG", &cliParseNop},
    {str_lit("-cfg-svg"),   0, CLI_CFG_CREATE_SVG, "-cfg-svg", "Create graphviz control flow graph as a SVG", &cliParseNop},
    ...
    {str_lit("-clibs"),     1, CLI_CLIBS, "-clibs <libs>", "Link c libraries like: -clibs='-lSDL2 -lxml2 -lcurl...'", &cliParseString},
